...
var RebuildDBCommand = &cli.Command{
	...
	Action: func(ctx context.Context, cmd *cli.Command) error {
		...
		if remoteArtifactStore, ok := artifactStore.(artifacts.RemoteArtifactStore); ok {
			return remoteArtifactStore.SyncWithLocalStore(ctx, blobStore, blobStorePath, containerdContentStore)
		}
